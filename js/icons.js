const paths = {
  ...
  settings: `<path d="M9.2 3.4 10 2h4l.8 1.4 1.9.8 1.6-.4 2 3.4-1.1 1.2.2 2.1 1.3 1v4l-1.3 1-.2 2.1 1.1 1.2-2 3.4-1.6-.4-1.9.8L14 22h-4l-.8-1.4-1.9-.8-1.6.4-2-3.4 1.1-1.2-.2-2.1-1.3-1v-4l1.3-1 .2-2.1-1.1-1.2 2-3.4 1.6.4 1.9-.8Z"/><circle cx="12" cy="12" r="3.2"/>`,
  sound: `<path d="M4 9v6h4l5 4V5L8 9H4Z"/><path d="M16 8.5a5 5 0 0 1 0 7M18.5 6a8.5 8.5 0 0 1 0 12"/>`,
  mute: `<path d="M4 9v6h4l5 4V5L8 9H4Z"/><path d="m17 9 4 4M21 9l-4 4"/>`,
  speed: `<path d="M4 18a8 8 0 1 1 16 0"/><path d="m12 14 4-5"/><path d="M8 18h8"/>`,
  ...
  seed: `<path d="M12 4c4 2.6 6 6 6 9.1 0 4.3-2.9 7-6 7s-6-2.7-6-7C6 10 8 6.6 12 4Z"/><path d="M12 7.5c1.3 1.8 2 3.8 2 6.2 0 2.1-.7 3.6-2 4.8"/><path d="M9 12.5c1.6-.2 3.1-.8 4.4-1.8"/>`,
  coins: `<path d="M12 4c4 2.6 6 6 6 9.1 0 4.3-2.9 7-6 7s-6-2.7-6-7C6 10 8 6.6 12 4Z"/><path d="M12 7.5c1.3 1.8 2 3.8 2 6.2 0 2.1-.7 3.6-2 4.8"/><path d="M9 12.5c1.6-.2 3.1-.8 4.4-1.8"/>`,
